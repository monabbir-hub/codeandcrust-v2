...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "min-h-[150vh] flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px]",
        {
          "transform md:scale-100 scale-[1]": !isMobile,
          "transform scale-[0.7]": isMobile,
        }
      )}
    >
      <motion.h2
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <div className="object-cover items-center justify-center flex absolute rounded-lg inset-0 h-full w-full bg-black">
